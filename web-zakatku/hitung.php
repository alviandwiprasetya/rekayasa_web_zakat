              ...
              <header class="panel-heading">
                Tabel Hitung
                  <div class="btn-group pull-right">
                    <a href="hitung_tambah.php" class="btn btn-primary btn-sm" alt="Tambah Hitung"><span class="icon_plus_alt2"></span></a>
                  </div>
              </header>
                ...
                <tbody>
                  ...
                  <?php if(isset($hitungs) && count($hitungs)>0):?>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <a class="btn btn-info" href="hitung_edit.php?id=<?=$hitung['kode_hitung']?>"><i class="fa fa-edit"></i></a>
